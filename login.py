...
bg_icon=ImageTk.PhotoImage(file="S:\Project Code latest - Copy\Project Code latest - Copy\L.jpg")
user_icon=ImageTk.PhotoImage(file="S:\Project Code latest - Copy\Project Code latest - Copy\l1.png")
pass_icon=ImageTk.PhotoImage(file="S:\Project Code latest - Copy\Project Code latest - Copy\p1.jpg")
